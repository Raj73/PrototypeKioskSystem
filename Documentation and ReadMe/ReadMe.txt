...
How To Run
	1. Compile the application using Visual Studios
	2. Place the txt file list of scanned items here: ConsoleApplication1\bin\Debug\Data
	3. Run the executable ConsoleApplication1\bin\Debug\PrototypeKioskSystem.exe
	4. type the name of the file followed by .txt
	5. Hit 'Enter' to display the reciept
	6. Change the inventory or promotions by swaping files 'inventory.txt' or 'promotions' respectively
